...
namespace _200oker {
    public class Program {
        ...
        private static int Main (string[] args) {
            ...
            var header = "200OKer (https://github.com/carsales/200oker-core)";
            ...
            if (!String.IsNullOrEmpty (header)) {
                ...
                Parallel.ForEach (checks, new ParallelOptions () { MaxDegreeOfParallelism = Config.MaxParentThreads },
                    c => _checker.PerformCheck (c.Url, c.ChildSelector, false, header));
            } else {
                Parallel.ForEach (checks, new ParallelOptions () { MaxDegreeOfParallelism = Config.MaxParentThreads },
        ...
        private static void PrintApplicationInfo () {
            ...
            Console.WriteLine ("200OKer v{0} - http://github.com/carsales/200oker-core", version);
        }
    }
}